...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for accession in list_to_update:
            ...
            if reference_sam["ORGANISM_PART"] == "WHOLE_ORGANISM":
                ...
                registered_sample = subprocess.check_output(
                    curl_cmd, shell=True)
    ...
    def update_source(self, registered_sample, sample_accession, object):
        ...
        attributes = tree.find('SAMPLE').find(
            'SAMPLE_ATTRIBUTES').findall('SAMPLE_ATTRIBUTE')
        existing_tags = []
                        ...
                        try:
                            ...
                            if item[0] == 'COLLECTION_LOCATION':
                                ...
                                sample_attribute = ET.SubElement(
                                    attributes_block, 'SAMPLE_ATTRIBUTE')
    ...
    def update_sample_relationship(self, registered_sample, object):
        ...
        ET.dump(tree)
        tree.write(open(object['biosampleAccession'] +
                   ".xml", 'w'), encoding='unicode')
