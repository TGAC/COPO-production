...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for accession in updates_to_make:
            ...
            print(
                "************************************************************************\n")
            print("correct SPECIMEN_ID for biosample ",
            ...
            for possible_source in source_list:
                if possible_source["SPECIMEN_ID"] == correct_specimen:
                    ...
                    # print(ena_receipt)
                    report = json.loads(
                        ena_receipt.decode('utf8').replace("'", '"'))
                    correct_biosample = report[0]["report"].get(
                        "secondaryId", "")
                    print(
                        "************************************************************************\n")
                    print("source with SPECIMEN_ID ", specimen_to_correct,
                          " correct biosample is ", correct_biosample)
                    print(
                        "\n************************************************************************\n")
