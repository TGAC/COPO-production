...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        files = Component().create_component(name="files", title="Data Files", widget_icon="file", widget_colour="blue", widget_icon_class="fa fa-file", table_id="files_table", reverse_url="copo_file:copo_files", subtitle="")
