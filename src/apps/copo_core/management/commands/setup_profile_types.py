...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        submit_singlecell_multi_ena = RecordActionButton().create_record_action_button(name="submit_singlecell_multi_ena", title="Submit Single Cell Records to ENA", label="Submit to ENA", type="multi", error_message="Please select one or more record to submit", icon_class="fa fa-info-circle", action="submit_singlecell_ena", icon_colour="teal")
        submit_singlecell_multi_zenodo = RecordActionButton().create_record_action_button(name="submit_singlecell_multi_zenodo", title="Submit Single Cell Records to ZENODO", label="Submit to ZENODO", type="multi", error_message="Please select one or more record to submit", icon_class="fa fa-info-circle", action="submit_singlecell_zenodo", icon_colour="blue")
        publish_singlecell_multi_ena = RecordActionButton().create_record_action_button(name="publish_singlecell_multi_ena", title="Publish Single Cell Records to ENA", label="Publish to ENA", type="multi", error_message="Please select one or more record to publish", icon_class="fa fa-info-circle", action="publish_singlecell_ena", icon_colour="teal")
        publish_singlecell_multi_zenodo = RecordActionButton().create_record_action_button(name="publish_singlecell_multi_zenodo", title="Publish Single Cell Records to ZENODO", label="Publish to ZENODO", type="multi", error_message="Please select one or more record to publish", icon_class="fa fa-info-circle", action="publish_singlecell_zenodo", icon_colour="blue")
