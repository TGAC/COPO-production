MESSAGES = {
    'validation_msg_sample_duplication_error': 'The file, <strong>{filename}</strong>, '
                                               'is already linked to sample <strong>{existing_sample_name}</strong> in profile <strong class="title-ellipsis">{existing_sample_profile_title}</strong>, '
                                               'with checklist <strong>{existing_sample_checklist}</strong>.',
