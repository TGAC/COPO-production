        ...
        news_items = [
            {
                ...
                'content': '<p>All Collaborative OPen Omics (COPO) services were disrupted for about 2 weeks in May, 2024 due to a technical issue.</p> <p>Please accept our apologies for any inconvenience that the disruption may have caused.</p>',
            ...
            },
            {
                ...
                'content': '<p>The Collaborative OPen Omics (COPO) project now has extensive documentation aimed at enhancing user experience, website usability and accessibility.</p><p>The documentation covers all aspects of COPO\'s functionalities, from metadata submissions, data file submissions, permit submissions and image submissions, to advanced features, providing a valuable resource for researchers and scientists in the field of biodiversity. Users can access step-by-step guides, visual aides and frequently asked questions, making it easier than ever to leverage COPO\'s powerful metadata brokering platform for their research need.</p> <p>Explore the <a href="https://copo-docs.readthedocs.io/en/latest" target="_blank">documentation</a> today and discover how COPO can streamline your metadata, data files and sharing processes.</p>',
                'category': NewsCategory.objects.get(name='General'),
                'author': 'COPO Project Team',
            ...
            },
            {
                ...
                'content': '<p>In an effort to improve user support and accessibility, the Collaborative OPen Omics (COPO) initiative has launched a comprehensive <a href="https://copo-docs.readthedocs.io/en/latest/help/faq.html" target="_blank">Frequently Asked Questions (FAQ)</a> section on its website.</p> <p>This new resource addresses common queries and provides detailed answers on topics ranging from account setup to data submission protocols. By offering clear and concise information, COPO aims to streamline the user experience, ensuring that researchers can efficiently utilise the platform\'s full range of features.</p>',
                'category': NewsCategory.objects.get(name='General'),
                'author': 'COPO Project Team',
            ...
            },
            {
                ...
                'content': '<p>We are excited to announce the appointment of our new project group leader, <a href="https://www.earlham.ac.uk/profile/irene-papatheodorou" target="_blank">Professor Irene Papatheodorou</a>. Irene will be leading a group of skilled data-led scientists as the Head of Data Science at the <a href="https://www.earlham.ac.uk" target="_blank">Earlham Institute</a>, in Norwich, United Kingdom.</p><p>With a wealth of experience in single cell transcriptomics, bioinformatics and leadership, Irene will drive forward COPO\'s mission to enhance single-cell genomics, spatial transcriptomics and other research efforts.</p> <p>Stay tuned for more updates on the innovative projects and initiatives under her leadership.</p>',
                'category': NewsCategory.objects.get(name='General'),
                'author': 'COPO Project Team',
            ...
            },
            {
                ...
                'content': '<p>Researchers, metadata providers and metadata submitters can now seamlessly track the status of data file submissions after COPO deposits them to <a href="https://www.ebi.ac.uk/ena/browser/home" target="_blank">European Nucleotide Archive (ENA)</a> after the data files have been submitted through COPO.</p><p>After having uploaded data files and completed metadata submissions in COPO, stay informed with real-time updates on the processing progress. This new feature enhances transparency and ensures that you are always in the loop about your data file submissions.</p> <p>See our <a href="https://copo-docs.readthedocs.io/en/latest/submissions/files.html#checking-ena-file-upload-status" target="_blank">documentation</a> for more information on how to track the data file processing status.</p>',
                'category': NewsCategory.objects.get(name='Feature'),
                'author': 'COPO Project Team',
            ...
            },
            {
                ...
                'content': '<p>Tree of Life (ToL) projects brokered through COPO can now process reads, sequencing annotations and assemblies more efficiently than ever.</p> <p>This advancement supports comprehensive analysis and accelerates research timelines, providing researchers with robust tools to delve deeper into life science and biodiversity research.</p> <p> See our <a href="https://copo-docs.readthedocs.io/en/latest/profile/tol/tol-profile-walkthrough.html" target="_blank">guidelines</a> about how to create a Tree of Life profile in order to submit your desired research object through COPO.</p>',
                'category': NewsCategory.objects.get(name='Feature'),
                'author': 'COPO Project Team',
                'news_image': '/copo/static/assets/img/copo_logo_new.png',
                'is_news_article_active': True
            },
            {
                ...
                'content': 'COPO now allows researchers to view accession numbers for their submissions, streamlining the process for analysis and publications. These accession numbers are critical for referencing in scholarly articles and ensuring reproducibility in research, enhancing the integrity and visibility of your work.',
                'category': NewsCategory.objects.get(name='Feature'),
                'author': 'COPO Project Team',
            ...
            },
            {
                ...
                'content': '<p>We are thrilled to unveil the newly refactored and redesigned COPO project website, complete with a fresh logo and an updated codebase. The revamped site offers an improved user experience, featuring a sleek design and enhanced functionality.</p> <p>Explore the new features and discover how COPO continues to support the scientific community with cutting-edge tools and resources.</p>',
                'category': NewsCategory.objects.get(name='Feature'),
                'author': 'COPO Project Team',
