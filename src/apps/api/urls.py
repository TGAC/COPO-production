...
manifest_patterns = [
    re_path(r'get_latest_manifest_versions/', manifest_view.get_latest_manifest_versions,
            name="get_latest_manifest_versions"),
    re_path(r'get_manifest_fields/', manifest_view.get_manifest_fields,
            name="get_manifest_fields"),
    re_path(r'get_common_value_dropdown_list/', manifest_view.get_common_value_dropdown_list,
            name="get_common_value_dropdown_list"),
    re_path(r'generate_manifest_template', manifest_view.generate_manifest_template,
            name="generate_manifest_template"),
    re_path(r'validate_common_value', manifest_view.validate_common_value,
            name="validate_common_value"),
    re_path(r'index', TemplateView.as_view(
