...
urlpatterns = [
    ...
    path(
        'copo/copo_sample/',
        include('src.apps.copo_sample.urls', namespace='copo_sample'),
    ),
    path(
        'copo/dtol_manifest/',
        include('src.apps.copo_dtol_upload.urls', namespace='copo_dtol_upload'),
    ),
    path(
        'copo/dtol_submission/',
        include('src.apps.copo_dtol_submission.urls', namespace='copo_dtol_submission'),
    ),
    path(
        'copo/copo_read/',
    ...
    path(
        'copo/copo_assembly/',
        include(
            'src.apps.copo_assembly_submission.urls',
            namespace='copo_assembly_submission',
        ),
    ),
    path(
        'copo/copo_seq_annotation/',
        include(
            'src.apps.copo_seq_annotation_submission.urls',
            namespace='copo_seq_annotation_submission',
        ),
    ),
    path(
        'copo/copo_taggedseq/',
        include(
            'src.apps.copo_barcoding_submission.urls',
            namespace='copo_barcoding_submission',
        ),
    ),
    ...
    re_path(
        r'^copo/', include('src.apps.copo_profile.urls', namespace='copo_profile_index')
    ),
    path(
        'copo/copo_profile/',
        include('src.apps.copo_profile.urls', namespace='copo_profile'),
    ),
    path(
        'accounts/profile/',
        include('src.apps.copo_profile.urls', namespace='copo_account_profile_index'),
    ),
    path(
        'copo/copo_accessions/',
    ...
    path(
        'is_user_email_address_provided/',
        landing_views.is_user_email_address_provided,
        name='is_user_email_address_provided',
    ),
    path('about/', TemplateView.as_view(template_name="about.html"), name='about'),
    path(
        'about/privacy_notice/',
        TemplateView.as_view(template_name="privacy_notice.html"),
        name='privacy_notice',
    ),
    path(
        'about/terms_of_use/',
