  ...
  return (
    m.extend(s.prototype, {
      ...
      _stickyPosition: function (t, i) {
        var s, n;
        this._scrollEnabled() &&
          ((n = 'rtl' === m((s = this).s.dt.table().node()).css('direction')),
      ...
      _modeChange: function (t, e, o) {
        ...
        ('footer' === e && c) ||
          ...
          (s = m.contains(r[0], x.activeElement) ? x.activeElement : null),
          ...
          'in-place' === t
            ? (f.placeholder &&
              ...
              m(m(f.host.parent()).parent()).scrollLeft(d.scrollLeft()))
            : 'in' === t
            ? (this._clone(e, o),
              (r = d.offset()),
              ...
              (d =
                'footer' === e
                  ? h < a
                    ? l.tfootHeight
                    : a + l.tfootHeight - h
                  : n + this.c.headerOffset + l.theadHeight - r),
        ...
        this.s.dt.settings()[0].bDestroying ||
          ...
          this.c.header &&
            ...
            s + this.c.headerOffset + u.theadHeight <= b
              ...
              : (h = 'below'),
            (!t && h === this.s.headerMode) || this._modeChange(h, 'header', t),
          ...
          this.c.footer &&
            ...
            u.tfootBottom + this.c.footerOffset <= a
              ...
              ? ((n = 'in'), (t = !0))
              : (n = 'above'),
            (!t && n === this.s.footerMode) || this._modeChange(n, 'footer', t),
            ...
            ((u =
              ...
              (p.offset.top + (c < -p.height ? p.height : 0) + g.height)),
    ...
    m(x).on('init.dt.dtfh', function (t, e, o) {
      var i;
      'dt' === t.namespace &&
        ((t = e.oInit.fixedHeader), (i = n.defaults.fixedHeader), t || i) &&
        !e._fixedHeader &&
        ((i = m.extend({}, i, t)), !1 !== t) &&
        new s(e, i);
    }),
