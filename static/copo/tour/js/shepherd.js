...
class Evented {
  ...
  on(event, handler, ctx, once = false) {
    ...
    (_this$bindings$event = this.bindings[event]) == null ||
      _this$bindings$event.push({
        handler,
        ctx,
        once,
      });
  ...
  off(event, handler) {
    ...
    if (isUndefined(handler)) {
      ...
      (_this$bindings$event2 = this.bindings[event]) == null ||
        _this$bindings$event2.forEach((binding, index) => {
          if (binding.handler === handler) {
            var _this$bindings$event3;
            (_this$bindings$event3 = this.bindings[event]) == null ||
              _this$bindings$event3.splice(index, 1);
          }
        });
    }
    return this;
  ...
  trigger(event, ...args) {
    if (!isUndefined(this.bindings) && this.bindings[event]) {
      ...
      (_this$bindings$event4 = this.bindings[event]) == null ||
        _this$bindings$event4.forEach((binding, index) => {
          const { ctx, handler, once } = binding;
          const context = ctx || this;
          handler.apply(context, args);
          if (once) {
            var _this$bindings$event5;
            (_this$bindings$event5 = this.bindings[event]) == null ||
              _this$bindings$event5.splice(index, 1);
          }
        });
    }
    return this;
...
function getUtils(options, customizedDeepmerge) {
  ...
  return {
    ...
    metaDataUpdater:
      (_options$metaDataUpda = options.metaDataUpdater) != null
        ? _options$metaDataUpda
        : defaultMetaDataUpdater,
    deepmerge: customizedDeepmerge,
    useImplicitDefaultMerging:
      (_options$enableImplic = options.enableImplicitDefaultMerging) != null
        ? _options$enableImplic
        : false,
    filterValues:
      options.filterValues === false
        ? undefined
        : (_options$filterValues = options.filterValues) != null
        ? _options$filterValues
        : defaultFilterValues,
    actions,
  };
}
...
function mergeUnknowns(values, utils, meta) {
  ...
  const filteredValues =
    (_utils$filterValues =
      utils.filterValues == null ? void 0 : utils.filterValues(values, meta)) !=
    null
      ? _utils$filterValues
      : values;
  ...
  return {
    ...
    async fn(state) {
      ...
      const _evaluate = evaluate(options, state),
        ...
        detectOverflowOptions = _objectWithoutPropertiesLoose(
          _evaluate,
          _excluded
        );
      const placements$1 =
...
const computePosition = (reference, floating, options) => {
  ...
  return computePosition$1(
    reference,
    floating,
    _extends({}, mergedOptions, {
...
function getFloatingUIOptions(attachToOptions, step) {
  ...
  const hasAutoPlacement =
    (_attachToOptions$on = attachToOptions.on) == null
      ? void 0
      : _attachToOptions$on.includes('auto');
  const hasEdgeAlignment =
    (attachToOptions == null ||
    (_attachToOptions$on2 = attachToOptions.on) == null
      ? void 0
      : _attachToOptions$on2.includes('-start')) ||
    (attachToOptions == null ||
    (_attachToOptions$on3 = attachToOptions.on) == null
      ? void 0
      : _attachToOptions$on3.includes('-end'));
  if (!shouldCenter) {
    if (hasAutoPlacement) {
      ...
      options.middleware.push(
        autoPlacement({
          ...
          alignment: hasEdgeAlignment
            ? attachToOptions == null ||
              (_attachToOptions$on4 = attachToOptions.on) == null
              ? void 0
              : _attachToOptions$on4.split('-').pop()
            : null,
        })
      );
    } else {
...
function ensure_array_like(array_like_or_iterator) {
  return (array_like_or_iterator == null
    ? void 0
    : array_like_or_iterator.length) !== undefined
  ...
  return {
    c() {
      ...
      attr(
        button,
        'aria-label',
        (button_aria_label_value = /*label*/ ctx[3] ? /*label*/ ctx[3] : null)
      );
      attr(
        button,
        'class',
        (button_class_value = `${/*classes*/ ctx[1] || ''} shepherd-button ${
          /*secondary*/ ctx[4] ? 'shepherd-button-secondary' : ''
        }`)
      );
    ...
    m(target, anchor) {
      ...
      if (!mounted) {
        dispose = listen(button, 'click', function () {
          if (is_function(/*action*/ ctx[0]))
            /*action*/ ctx[0].apply(this, arguments);
        });
        mounted = true;
      }
    },
    ...
    if ($$self.$$.dirty & /*config, step*/ 192) {
      {
        ...
        $$invalidate(
          ...
          (disabled = config.disabled
            ? getConfigOption(config.disabled)
            : false)
        );
        $$invalidate(
          3,
...
function create_each_block(ctx) {
  ...
  return {
    ...
    p(ctx, dirty) {
      ...
      if (dirty & /*buttons*/ 2)
        shepherdbutton_changes.config = /*config*/ ctx[2];
  ...
  return {
    c() {
      ...
      attr(
        button,
        'aria-label',
        (button_aria_label_value = /*cancelIcon*/ ctx[0].label
          ? /*cancelIcon*/ ctx[0].label
          : 'Close Tour')
      );
...
function create_if_block_1$1(ctx) {
  ...
  return {
    ...
    p(ctx, dirty) {
      ...
      if (dirty & /*labelId*/ 1)
        shepherdtitle_changes.labelId = /*labelId*/ ctx[0];
  ...
  return {
    ...
    p(ctx, dirty) {
      ...
      if (dirty & /*cancelIcon*/ 8)
        shepherdcancelicon_changes.cancelIcon = /*cancelIcon*/ ctx[3];
...
function create_if_block_2(ctx) {
  ...
  return {
    ...
    p(ctx, dirty) {
      ...
      if (dirty & /*labelId*/ 2)
        shepherdheader_changes.labelId = /*labelId*/ ctx[1];
...
function create_if_block_1(ctx) {
  ...
  return {
    ...
    p(ctx, dirty) {
      ...
      if (dirty & /*descriptionId*/ 1)
        shepherdtext_changes.descriptionId = /*descriptionId*/ ctx[0];
...
function create_fragment$2(ctx) {
  let div;
  let show_if_2 =
    !isUndefined(/*step*/ ctx[2].options.title) ||
    /*step*/ (ctx[2].options.cancelIcon &&
      /*step*/ ctx[2].options.cancelIcon.enabled);
  let t0;
  let show_if_1 = !isUndefined(/*step*/ ctx[2].options.text);
  let t1;
  let show_if =
    Array.isArray(/*step*/ ctx[2].options.buttons) &&
    /*step*/ ctx[2].options.buttons.length;
  let current;
  ...
  return {
    ...
    p(ctx, [dirty]) {
      ...
      if (dirty & /*step*/ 4)
        show_if_1 = !isUndefined(/*step*/ ctx[2].options.text);
      if (show_if_1) {
        if (if_block1) {
          if_block1.p(ctx, dirty);
          if (dirty & /*step*/ 4) {
...
function create_fragment$1(ctx) {
  ...
  let dispose;
  let if_block =
    /*step*/ ctx[4].options.arrow &&
    /*step*/ ctx[4].options.attachTo &&
    /*step*/ ctx[4].options.attachTo.element &&
    /*step*/ ctx[4].options.attachTo.on &&
    create_if_block();
  ...
  let dialog_levels = [
    {
      'aria-describedby': (dialog_aria_describedby_value = !isUndefined(
        /*step*/ ctx[4].options.text
      )
        ? /*descriptionId*/ ctx[2]
        : null),
    },
    {
      'aria-labelledby': (dialog_aria_labelledby_value = /*step*/ ctx[4].options
        .title
        ? /*labelId*/ ctx[3]
        : null),
    },
  ...
  return {
    ...
    p(ctx, [dirty]) {
      ...
      if (dirty & /*descriptionId*/ 4)
        shepherdcontent_changes.descriptionId = /*descriptionId*/ ctx[2];
      if (dirty & /*labelId*/ 8)
        shepherdcontent_changes.labelId = /*labelId*/ ctx[3];
      if (dirty & /*step*/ 16) shepherdcontent_changes.step = /*step*/ ctx[4];
      shepherdcontent.$set(shepherdcontent_changes);
      set_attributes(
        dialog,
        (dialog_data = get_spread_update(dialog_levels, [
          (!current ||
            (dirty & /*step, descriptionId*/ 20 &&
              dialog_aria_describedby_value !==
                (dialog_aria_describedby_value = !isUndefined(
                  /*step*/ ctx[4].options.text
                )
                  ? /*descriptionId*/ ctx[2]
                  : null))) && {
          ...
          (!current ||
            (dirty & /*step, labelId*/ 24 &&
              dialog_aria_labelledby_value !==
                (dialog_aria_labelledby_value = /*step*/ ctx[4].options.title
                  ? /*labelId*/ ctx[3]
                  : null))) && {
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  onDestroy(() => {
    ...
    (_attachToElement = attachToElement) == null ||
      _attachToElement.removeEventListener('keydown', handleKeyDown);
  });
  afterUpdate(() => {
      ...
      case KEY_TAB:
        ...
        if (e.shiftKey) {
          ...
          if (
            ...
            e.preventDefault();
            ((_lastFocusableAttachT = lastFocusableAttachToElement) != null
              ? _lastFocusableAttachT
              : lastFocusableDialogElement
            ).focus();
          }
          ...
          if (document.activeElement === lastFocusableDialogElement) {
            ...
            e.preventDefault();
            ((_firstFocusableAttach = firstFocusableAttachToElement) != null
              ? _firstFocusableAttach
              : firstFocusableDialogElement
            ).focus();
          }
  ...
  $$self.$$set = ($$props) => {
    if ('attachToElement' in $$props)
      $$invalidate(8, (attachToElement = $$props.attachToElement));
    if ('attachTofocusableDialogElements' in $$props)
      $$invalidate(
        15,
        (attachTofocusableDialogElements =
          $$props.attachTofocusableDialogElements)
      );
    if ('classPrefix' in $$props)
      $$invalidate(16, (classPrefix = $$props.classPrefix));
    if ('element' in $$props) $$invalidate(0, (element = $$props.element));
    if ('descriptionId' in $$props)
      $$invalidate(2, (descriptionId = $$props.descriptionId));
    if ('focusableAttachToElements' in $$props)
      $$invalidate(
        9,
        (focusableAttachToElements = $$props.focusableAttachToElements)
      );
    if ('firstFocusableAttachToElement' in $$props)
      $$invalidate(
        10,
        (firstFocusableAttachToElement = $$props.firstFocusableAttachToElement)
      );
    if ('lastFocusableAttachToElement' in $$props)
      $$invalidate(
        11,
        (lastFocusableAttachToElement = $$props.lastFocusableAttachToElement)
      );
    if ('firstFocusableDialogElement' in $$props)
      $$invalidate(
        12,
        (firstFocusableDialogElement = $$props.firstFocusableDialogElement)
      );
    if ('focusableDialogElements' in $$props)
      $$invalidate(
        13,
        (focusableDialogElements = $$props.focusableDialogElements)
      );
    if ('lastFocusableDialogElement' in $$props)
      $$invalidate(
        14,
        (lastFocusableDialogElement = $$props.lastFocusableDialogElement)
      );
...
class Step extends Evented {
  ...
  _show() {
    ...
    (_this$tour$modal2 = this.tour.modal) == null ||
      _this$tour$modal2.setupForStep(this);
  ...
  return {
    c() {
      ...
      attr(
        ...
        'class',
        (svg_class_value = `${
          /*modalIsVisible*/ ctx[1] ? 'shepherd-modal-is-visible' : ''
    ...
    m(target, anchor) {
      ...
      if (!mounted) {
        dispose = listen(
          svg,
          'touchmove',
          /*_preventModalOverlayTouch*/ ctx[3]
        );
        mounted = true;
      }
    },
  ...
  while (targetWindow !== window.top) {
    ...
    const targetIframe =
      (_targetWindow = targetWindow) == null
        ? void 0
        : _targetWindow.frameElement;
    if (targetIframe) {
      var _targetIframeRect$scr, _targetIframeRect$scr2;
      const targetIframeRect = targetIframe.getBoundingClientRect();
      offset.top +=
        targetIframeRect.top +
        ((_targetIframeRect$scr = targetIframeRect.scrollTop) != null
          ? _targetIframeRect$scr
          : 0);
      offset.left +=
        targetIframeRect.left +
        ((_targetIframeRect$scr2 = targetIframeRect.scrollLeft) != null
          ? _targetIframeRect$scr2
          : 0);
    }
