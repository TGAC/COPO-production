...
!(function (p, h, v, b) {
  (p.site = p.fn.site =
    function (e) {
      ...
      return (
        n
          ? (m === b && g.initialize(), g.invoke(t))
          : (m !== b && g.destroy(), g.initialize()),
        s !== b ? s : this
      );
    }),
    (p.site.settings = {
          ...
          w.each(function () {
            var n,
              ...
              y = {
                ...
                destroy: function () {
                  y.verbose('Destroying previous module', p),
                    y.removeEvents(),
                    r.removeData(a);
                },
                refresh: function () {
                ...
                bindEvents: function () {
                  y.verbose('Attaching form events'),
                    ...
                    d.keyboardShortcuts &&
                      r.on('keydown' + g, f.field, y.event.field.keydown),
                    n.each(function () {
                      var e = F(this),
                        t = e.prop('type'),
                  ...
                  n.each(function () {
                    ...
                    o !== D &&
                      ...
                      r
                        ...
                        : a
                        ? (y.verbose('Resetting checkbox value', t, o),
                          e.prop('checked', o))
                ...
                is: {
                  ...
                  valid: function (e) {
                    var n = !0;
                    return e
                      ? (y.verbose('Checking if field is valid', e),
                        y.validate.field(c[e], e, !1))
                  ...
                  field: {
                    keydown: function (e) {
                      var t = F(this),
                        ...
                        r = 13;
                      n == 27 &&
                        (y.verbose('Escape key pressed blurring field'),
                        t.blur()),
                        e.ctrlKey ||
                          n != r ||
                          !i ||
                    ...
                    blur: function (e) {
                      ...
                      n.hasClass(m.error)
                        ? (y.debug('Revalidating field', t, i),
                          i && y.validate.field(i))
                    ...
                    change: function (e) {
                      ...
                      i &&
                        ...
                        (y.timer = setTimeout(function () {
                          y.debug('Revalidating field', t, y.get.validation(t)),
                            y.validate.field(i);
                        }, d.delay)));
                    },
                  },
                  ...
                  prompt: function (e, t) {
                    ...
                    return (
                      ...
                      u &&
                        ((i =
                          1 ==
                          (n = r.closest(f.group).find('label').eq(0)).length
                            ? n.text()
                ...
                has: {
                  field: function (e) {
                    return (
                      ...
                      'string' != typeof (e = y.escape.string(e)) &&
                        y.error(s.identifier, e),
                      0 < n.filter('#' + e).length ||
                        0 < n.filter('[name="' + e + '"]').length ||
                        0 <
                          n.filter('[data-' + u.validate + '="' + e + '"]')
                ...
                add: {
                  ...
                  fields: function (e) {
                    var t =
                      e && y.is.shorthandFields(e)
                        ? y.get.fieldsFromShorthand(e)
                        : e;
                    c = F.extend({}, c, t);
                  },
                  prompt: function (e, t) {
                ...
                remove: {
                  rule: function (n, e) {
                    ...
                    if (e == D)
                      return (
                        y.debug('Removed all rules'), void (c[n].rules = [])
                      );
                    c[n] != D &&
                      F.isArray(c[n].rules) &&
                      F.each(c[n].rules, function (e, t) {
                        -1 !== i.indexOf(t.type) &&
                          (y.debug('Removed rule', t.type),
                      ...
                      F.each(e, function (e, t) {
                        ...
                        0 < i.length &&
                          (a && r
                            ...
                            : (y.verbose('Setting field value', t, i),
                              i.val(t)));
                      });
                  },
                },
                validate: {
                  ...
                  field: function (n, e, t) {
                    (t = t === D || t),
                      'string' == typeof n &&
                        (y.verbose('Validating field', n), (n = c[(e = n)]));
                    ...
                    return (
                      n.identifier ||
                        (y.debug('Using field name as identifier', i),
                        (n.identifier = i)),
                      o.prop('disabled')
                        ? (y.debug('Field is disabled. Skipping', i), (r = !0))
                        : n.optional && y.is.blank(o)
                        ? (y.debug('Field is optional and blank. Skipping', i),
                          (r = !0))
          ...
          r.each(function () {
            var e,
              ...
              h = {
                ...
                destroy: function () {
                  h.debug('Destroying previous instance', f),
                    f.off(n).removeData(i);
                },
                refresh: function () {
                ...
                bind: {
                  events: function () {
                    h.debug('Binding delegated events'),
                      f.on(c.on + n, d.trigger, h.event.click);
                  },
                },
                event: {
                  click: function () {
                ...
                setting: function (e, t) {
                  if ((h.debug('Changing setting', e, t), S.isPlainObject(e)))
                    S.extend(!0, c, e);
                  else {
                    if (t === T) return c[e];
                ...
                internal: function (e, t) {
                  if ((h.debug('Changing internal', e, t), t === T))
                    return h[e];
                      ...
                      S.each(i, function (e, t) {
                        ...
                        if (S.isPlainObject(r[n]) && e != o) r = r[n];
                          ...
                          if (!S.isPlainObject(r[t]) || e == o)
                            return (
                              r[t] !== T ? (a = r[t]) : h.error(s.method, i), !1
                            );
                          r = r[t];
                        }
                      })),
          ...
          e.each(function () {
            var e,
              ...
              h = {
                ...
                refresh: function () {
                  (c = l.children(o.label)),
                    (u = l.children(o.input)),
                    (d = u[0]);
                },
                hide: {
                  input: function () {
                ...
                check: function () {
                  h.should.allowCheck() &&
                    ...
                    h.should.ignoreCallbacks() ||
                      (i.onChecked.call(d), i.onChange.call(d)));
                },
                uncheck: function () {
                  h.should.allowUncheck() &&
                    ...
                    h.set.unchecked(),
                    h.should.ignoreCallbacks() ||
                      (i.onUnchecked.call(d), i.onChange.call(d)));
                },
                indeterminate: function () {
                  h.should.allowIndeterminate()
                    ...
                    : (h.debug('Making checkbox indeterminate'),
                      h.set.indeterminate(),
                      h.should.ignoreCallbacks() ||
                        (i.onIndeterminate.call(d), i.onChange.call(d)));
                },
                determinate: function () {
                  h.should.allowDeterminate()
                    ...
                    : (h.debug('Making checkbox determinate'),
                      h.set.determinate(),
                      h.should.ignoreCallbacks() ||
                        (i.onDeterminate.call(d), i.onChange.call(d)));
                },
                enable: function () {
                  h.is.enabled()
                ...
                is: {
                  ...
                  indeterminate: function () {
                    return (
                      u.prop('indeterminate') !== P && u.prop('indeterminate')
                    );
                  },
                  checked: function () {
                ...
                create: {
                  label: function () {
                    0 < u.prevAll(o.label).length
                      ...
                      : h.has.label() ||
                        ((c = T('<label>').insertAfter(u)),
                        h.debug('Creating label', c));
                  },
                },
                has: {
                  label: function () {
                ...
                setting: function (e, t) {
                  if ((h.debug('Changing setting', e, t), T.isPlainObject(e)))
                    T.extend(!0, i, e);
                  else {
                    if (t === P) return i[e];
                      ...
                      T.each(i, function (e, t) {
                        ...
                        if (T.isPlainObject(r[n]) && e != o) r = r[n];
                          ...
                          if (!T.isPlainObject(r[t]) || e == o)
                            return (
                              r[t] !== P ? (a = r[t]) : h.error(s.method, i), !1
                            );
                          r = r[t];
                        }
                      })),
              ...
              g = {
                ...
                bind: {
                  events: function () {
                    'hover' == r.on
                      ? t
                          .on('mouseenter' + o, g.show)
                          .on('mouseleave' + o, g.hide)
                      : 'click' == r.on && t.on(u + o, g.toggle),
                      g.is.page() &&
                        (g.debug('Setting as a page dimmer', t),
                        g.set.pageDimmer()),
                      g.is.closable() &&
                ...
                create: function () {
                  ...
                  return (
                    r.dimmerName &&
                      (g.debug('Creating named dimmer', r.dimmerName),
                ...
                toggle: function () {
                  g.verbose('Toggling dimmer visibility', a),
                    g.is.dimmed() ? g.hide() : g.show();
                },
                animate: {
                  show: function (e) {
                    (e = S.isFunction(e) ? e : function () {}),
                      ...
                      a.transition('is supported')
                        ? (r.useFlex
                            ...
                            : (g.debug('Using legacy non-flex dimmer'),
                              g.set.legacy()),
                ...
                setting: function (e, t) {
                  if ((g.debug('Changing setting', e, t), S.isPlainObject(e)))
                    S.extend(!0, r, e);
                  else {
                    if (t === T) return r[e];
                    ...
                    'string' == typeof i &&
                      ...
                      S.each(i, function (e, t) {
                        ...
                        if (S.isPlainObject(r[n]) && e != o) r = r[n];
                          ...
                          if (!S.isPlainObject(r[t]) || e == o)
                            return (
                              r[t] !== T ? (a = r[t]) : g.error(s.method, i), !1
                            );
                          r = r[t];
                        }
                      })),
          ...
          V.each(function (n) {
            var e,
              ...
              I = {
                ...
                instantiate: function () {
                  I.verbose('Storing instance of dropdown', I),
                    (z = I),
                    C.data(x, I);
                },
                destroy: function () {
                ...
                observe: {
                  select: function () {
                    I.has.input() &&
                      r.observe(C[0], { childList: !0, subtree: !0 });
                  },
                  menu: function () {
                    I.has.menu() &&
                      s.observe(E[0], { childList: !0, subtree: !0 });
                  },
                },
                create: {
                  id: function () {
                  ...
                  userChoice: function (e) {
                    ...
                    return (
                      ...
                      Y.each(e, function (e, t) {
                        !1 === I.get.item(t) &&
                          ((o = g.templates.addition(
                            I.add.variables(c.addResult, t)
                          )),
                          (i = Y('<div />')
                            .html(o)
                            .attr('data-' + v.value, t)
                  ...
                  userLabels: function (e) {
                    ...
                    t &&
                      ...
                      Y.each(t, function (e, t) {
                        I.verbose('Adding custom user value'),
                          I.add.label(t, t);
                      }));
                  },
                  menu: function () {
                ...
                select: {
                  ...
                  nextAvailable: function (e) {
                    ...
                    0 < t.length
                      ? (I.verbose('Moving selection to', t),
                        t.addClass(p.selected))
                      : (I.verbose('Moving selection to', n),
                ...
                setup: {
                  ...
                  layout: function () {
                    C.is('select') &&
                      (I.setup.select(), I.setup.returnedObject()),
                      ...
                      0 < A.parent(b.dropdown).length
                        ...
                        : (I.debug('Creating entire dropdown from select'),
                          ...
                          A.hasClass(p.multiple) &&
                            !1 === A.prop('multiple') &&
                            (I.error(f.missingMultiple),
                            A.prop('multiple', !0)),
                          A.is('[multiple]') && I.set.multiple(),
                          A.prop('disabled') &&
                            (I.debug('Disabling dropdown'),
                ...
                refreshData: function () {
                  I.verbose('Refreshing cached metadata'),
                ...
                toggle: function () {
                  I.verbose('Toggling menu visibility'),
                    I.is.active() ? I.hide() : I.show();
                },
                show: function (e) {
                  if (
                ...
                bind: {
                  ...
                  touchEvents: function () {
                    I.debug(
                      ...
                      I.is.searchSelection() ||
                        (I.is.single() &&
                          C.on('touchstart' + y, I.event.test.toggle)),
                  ...
                  keyboardEvents: function () {
                    I.verbose('Binding keyboard events'),
                      ...
                      I.has.search() &&
                        C.on(I.get.inputEvent() + y, b.search, I.event.input),
                      I.is.multiple() &&
                        N.on('keydown' + o, I.event.document.keydown);
                  },
                ...
                filter: function (e) {
                  function t() {
                    I.is.multiple() && I.filterActive(),
                      (e || (!e && 0 == I.get.activeItem().length)) &&
                        I.select.firstUnfiltered(),
                      I.has.allResultsFiltered()
                  ...
                  var t = {
                    ...
                    onSuccess: function (e) {
                      ...
                      Y.isArray(t) && 0 < t.length
                        ? (I.remove.message(),
                          I.setup.menu({ values: e[l.remoteValues] }))
                        : I.add.message(c.noResults),
                        n();
                    },
                  };
                  ...
                  I.has.query() &&
                    ...
                    F.each(function () {
                      ...
                      if ('both' == g.match || 'text' == g.match) {
                        if (
                          -1 !== (e = String(I.get.choiceText(n, !1))).search(a)
                        )
                          return o.push(this), !0;
                        if ('exact' === g.fullTextSearch && I.exactSearch(i, e))
                          return o.push(this), !0;
                        if (!0 === g.fullTextSearch && I.fuzzySearch(i, e))
                          return o.push(this), !0;
                      }
                      if ('both' == g.match || 'value' == g.match) {
                        if (
                          -1 !== (t = String(I.get.choiceValue(n, e))).search(a)
                        )
                          return o.push(this), !0;
                        if ('exact' === g.fullTextSearch && I.exactSearch(i, t))
                          return o.push(this), !0;
                        if (!0 === g.fullTextSearch && I.fuzzySearch(i, t))
                          return o.push(this), !0;
                      }
                    })),
                ...
                forceSelection: function () {
                  ...
                  g.allowAdditions && I.set.selected(I.get.query()),
                    I.remove.searchTerm();
                },
                change: {
                  values: function (e) {
                ...
                event: {
                  change: function () {
                    q ||
                      (I.debug('Input changed, updating selection'),
                      I.set.selected());
                  },
                  focus: function () {
                  ...
                  blur: function (e) {
                    (t = K.activeElement === this),
                      O || t || (I.remove.activeLabel(), I.hide());
                  },
                  mousedown: function () {
                  ...
                  click: function (e) {
                    Y(e.target).is(C) &&
                      (I.is.focusedOnSearch() ? I.show() : I.focusSearch());
                  },
                  search: {
                    focus: function () {
                      (O = !0),
                    ...
                    blur: function (e) {
                      (t = K.activeElement === this),
                        I.is.searchSelection() &&
                          ...
                          (D ||
                            t ||
                            (g.forceSelection && I.forceSelection(), I.hide())),
                        (i = !1);
                    },
                  },
                  icon: {
                  ...
                  input: function (e) {
                    (I.is.multiple() || I.is.searchSelection()) &&
                      I.set.filtered(),
                  ...
                  remove: {
                    click: function () {
                      var e = Y(this).parent();
                      e.hasClass(p.active)
                        ? I.remove.activeLabels()
                        : I.remove.activeLabels(e);
                    },
                  },
                  test: {
                    toggle: function (e) {
                      ...
                      I.is.bubbledLabelClick(e) ||
                        ...
                        (I.determine.eventOnElement(e, t) &&
                          e.preventDefault());
                    },
                    touch: function (e) {
                  ...
                  menu: {
                    mutation: function (e) {
                      var t = e[0],
                        ...
                        o = n.add(i),
                        a =
                          o.is(b.addition) || 0 < o.closest(b.addition).length,
                        r = o.is(b.message) || 0 < o.closest(b.message).length;
                      a || r
                        ? (I.debug('Updating item selector cache'),
                          I.refreshItems())
                        : (I.debug('Menu modified, updating selector cache'),
                          I.refresh());
                    },
                    mousedown: function () {
                      D = !0;
                        ...
                        l ||
                          ...
                          (I.is.searchSelection() &&
                            ...
                            I.is.focusedOnSearch() ||
                              ...
                              I.focusSearch(!0)),
                          g.useLabels ||
                            (I.remove.filteredItem(), I.set.scrollPosition(n)),
                          ...
                          ? (!f && !m) || r
                            ? r &&
                              (e.shiftKey
                                ...
                                : (I.verbose('Selecting previous label'),
                  ...
                  keydown: function (e) {
                    ...
                    if (I.is.inObject(t, h)) {
                      ...
                      if (
                        ...
                        t == h.pageUp &&
                          (I.scrollPage('up'), e.preventDefault()),
                          t == h.pageDown &&
                            (I.scrollPage('down'), e.preventDefault()),
                          t == h.escape &&
                            (I.verbose('Escape key pressed, closing dropdown'),
                            I.hide());
                      } else
                        m && e.preventDefault(),
                          t != h.downArrow ||
                      ...
                      I.has.search() ||
                        I.set.selectedLetter(String.fromCharCode(t));
                  },
                },
                trigger: {
                  change: function () {
                ...
                action: {
                  ...
                  activate: function (e, t, n) {
                    if (((t = t !== J ? t : e), I.can.activate(Y(n)))) {
                      if (
                        (I.set.selected(t, Y(n)),
                        I.is.multiple() && !I.is.allFiltered())
                      )
                        return;
                      I.hideAndClear();
                    }
                        ...
                        F.each(function () {
                          ...
                          if (null !== n && n !== J)
                            if (a)
                              ...
                              return (
                                I.verbose('Found select item by value', n, i),
                                (r = e),
                                !0
                              );
                        }),
                ...
                check: {
                  maxSelections: function (e) {
                    return (
                      !g.maxSelections ||
                      ((e = e !== J ? e : I.get.selectionCount()) >=
                      g.maxSelections
                        ? (I.debug('Maximum selection count reached'),
                          g.useLabels &&
                            (F.addClass(p.filtered),
                            I.add.message(c.maxSelections)),
                          !0)
                ...
                restore: {
                  defaults: function () {
                    I.clear(),
                      I.restore.defaultText(),
                      I.restore.defaultValue();
                  },
                  defaultText: function () {
                    var e = I.get.defaultText();
                    e === I.get.placeholderText
                      ? (I.debug('Restoring default placeholder text', e),
                        I.set.placeholderText(e))
                ...
                save: {
                  defaults: function () {
                    I.save.defaultText(),
                      I.save.placeholderText(),
                      I.save.defaultValue();
                  },
                  defaultValue: function () {
                    var e = I.get.value();
                    I.verbose('Saving default value as', e),
                      C.data(v.defaultValue, e);
                  },
                  defaultText: function () {
                    var e = I.get.text();
                    I.verbose('Saving default text as', e),
                      C.data(v.defaultText, e);
                  },
                  placeholderText: function () {
                    var e;
                    !1 !== g.placeholder &&
                ...
                set: {
                  filtered: function () {
                    ...
                    e &&
                      o &&
                      (I.verbose('Adjusting input width', a, g.glyphWidth),
                      k.css('width', a)),
                      o || (n && r)
                        ? (I.verbose('Hiding placeholder text'),
                          S.addClass(p.filtered))
                        : (e && (!n || r)) ||
                          (I.verbose('Showing placeholder text'),
                  ...
                  tabbable: function () {
                    I.is.searchSelection()
                      ...
                      : (I.debug('Added tabindex to dropdown'),
                        C.attr('tabindex') === J &&
                          (C.attr('tabindex', 0), E.attr('tabindex', -1)));
                  },
                  initialLoad: function () {
                  ...
                  selectedLetter: function (e) {
                    ...
                    i &&
                      ((t = n.nextAll(F).eq(0)),
                      I.has.firstLetter(t, e) && (o = t)),
                      o ||
                        F.each(function () {
                          if (I.has.firstLetter(Y(this), e))
                            return (o = Y(this)), !1;
                        }),
                      o &&
                        ...
                        g.selectOnKeydown &&
                          I.is.single() &&
                          I.set.selectedItem(o));
                  },
                  direction: function (e) {
                    'auto' == g.direction
                      ? (I.remove.upward(),
                        I.can.openDownward(e)
                          ? I.remove.upward(e)
                          : I.set.upward(e),
                        I.is.leftward(e) ||
                          I.can.openRightward(e) ||
                          I.set.leftward(e))
                  ...
                  value: function (e, t, n) {
                    ...
                    if (o) {
                      ...
                      I.verbose('Storing value in metadata', i, A),
                        i !== a && C.data(v.value, r);
                    I.is.single() &&
                      g.clearable &&
                      (i ? I.set.clearable() : I.remove.clearable()),
                      !1 === g.fireOnInit && I.is.initialLoad()
                  ...
                  exactly: function (e, t) {
                    I.debug('Setting selected to exact values'),
                      I.clear(),
                      I.set.selected(e, t);
                  },
                ...
                add: {
                      ...
                      I.has.label(e)
                        ...
                        : (g.label.variation && i.addClass(g.label.variation),
                          !0 === n
                            ...
                            : (I.debug('Adding selection label', i),
                              i.insertBefore(o)));
                  },
                  message: function (e) {
                  ...
                  optionValue: function (e) {
                    ...
                    0 <
                      A.find('option[value="' + I.escape.string(t) + '"]')
                        .length ||
                      (I.disconnect.selectObserver(),
                      I.is.single() &&
                      ...
                      ('' === e || o
                        ...
                        : (a
                            ? (n
                              ...
                              g.hideAdditions ||
                                ((t = g.templates.addition(
                                  I.add.variables(c.addResult, e)
                                )),
                                n.html(t)),
                              I.verbose(
                  ...
                  value: function (e, t, n) {
                    ...
                    I.has.value(e)
                      ...
                      : '' !== e
                      ? ((i = Y.isArray(o)
                          ? ((i = o.concat([e])), I.get.uniqueArray(i))
                          : [e]),
                        I.has.selectInput()
                          ? I.can.extendSelect() &&
                            (I.debug('Adding value to select', e, i, A),
                            I.add.optionValue(e))
                ...
                remove: {
                  ...
                  value: function (e, t, n) {
                    ...
                    I.has.selectInput()
                      ...
                      : (I.verbose('Removing from delimited values', e),
                        (i = (i = I.remove.arrayValue(e, o)).join(
                          g.delimiter
                        ))),
                      !1 === g.fireOnInit && I.is.initialLoad()
                    ...
                    (e = e || C.find(b.label)),
                      ...
                      e.each(function () {
                        ...
                        !1 !== g.onLabelRemove.call(e, t)
                          ? (I.remove.message(),
                            i
                              ? (I.remove.value(n), I.remove.label(n))
                              : I.remove.selected(n))
                  ...
                  tabbable: function () {
                    I.is.searchSelection()
                      ? (I.debug('Searchable dropdown initialized'),
                ...
                has: {
                  ...
                  minCharacters: function (e) {
                    return (
                      !g.minCharacters ||
                      (e = e !== J ? String(e) : String(I.get.query()))
                        .length >= g.minCharacters
                    );
                  },
                  ...
                  label: function (e) {
                    ...
                    return (
                      ...
                      0 <
                        n.filter(
                          '[data-' + v.value + '="' + I.escape.string(t) + '"]'
                        ).length
                    );
                  },
                  ...
                  value: function (e) {
                    return g.ignoreCase
                      ? I.has.valueIgnoringCase(e)
                      : I.has.valueMatchingCase(e);
                  },
                ...
                can: {
                  ...
                  openDownward: function (e) {
                    ...
                    return (
                      ...
                      (n = {
                        context: {
                          offset:
                            w.get(0) === Z ? { top: 0, left: 0 } : w.offset(),
                      ...
                      (o = (t = {
                        ...
                        ? (I.verbose('Dropdown can fit in context downward', t),
                          !0)
                        : t.below || t.above
                        ? (I.verbose(
                  ...
                  show: function () {
                    return (
                      !I.is.disabled() && (I.has.items() || I.has.message())
                    );
                  },
                  useAPI: function () {
                    return Y.fn.api !== J;
                ...
                animate: {
                  show: function (e, t) {
                    ...
                    (e = Y.isFunction(e) ? e : function () {}),
                      ...
                      I.is.selection() &&
                        I.set.scrollPosition(I.get.selectedItem(), !0),
                ...
                setting: function (e, t) {
                  if ((I.debug('Changing setting', e, t), Y.isPlainObject(e)))
                    Y.extend(!0, g, e);
                  else {
                    if (t === J) return g[e];
                      ...
                      Y.each(i, function (e, t) {
                        ...
                        if (Y.isPlainObject(r[n]) && e != o) r = r[n];
                          ...
                          if (!Y.isPlainObject(r[t]) || e == o)
                            return (
                              r[t] !== J ? (a = r[t]) : I.error(f.method, i), !1
                            );
                          r = r[t];
                        }
                      })),
          ...
          v.each(function () {
            var i = k.isPlainObject(p)
              ...
              g = {
                ...
                setting: function (e, t) {
                  if ((g.debug('Changing setting', e, t), k.isPlainObject(e)))
                    k.extend(!0, i, e);
                  else {
                    if (t === A) return i[e];
                      ...
                      k.each(i, function (e, t) {
                        ...
                        if (k.isPlainObject(r[n]) && e != o) r = r[n];
                          ...
                          if (!k.isPlainObject(r[t]) || e == o)
                            return (
                              r[t] !== A ? (a = r[t]) : g.error(s.method, i), !1
                            );
                          r = r[t];
                        }
                      })),
          ...
          e.each(function () {
            var n,
              ...
              C = {
                ...
                add: {
                  keyboardShortcuts: function () {
                    C.verbose('Adding keyboard shortcuts'),
                      T.on('keyup' + m, C.event.keyboard);
                  },
                },
                save: {
                  focus: function () {
                    0 < j(I.activeElement).closest(p).length ||
                ...
                cacheSizes: function () {
                  ...
                  (C.cache !== M && 0 === n) ||
                    ((C.cache = {
                      ...
                      contextHeight:
                        'body' == l.context ? j(z).height() : o.height(),
                    }),
                ...
                can: {
                  useFlex: function () {
                    return 'auto' == l.useFlex
                      ? l.detachable && !C.is.ie()
                      : l.useFlex;
                  },
                  fit: function () {
                ...
                set: {
                  ...
                  dimmerStyles: function () {
                    l.inverted
                      ? a.addClass(u.inverted)
                      : a.removeClass(u.inverted),
                      l.blurring
                        ? o.addClass(u.blurring)
                        : o.removeClass(u.blurring);
                  },
                  ...
                  scrolling: function () {
                    o.addClass(u.scrolling),
                      p.addClass(u.scrolling),
                      C.unbind.scrollLock();
                  },
                  legacy: function () {
                    p.addClass(u.legacy);
                ...
                setting: function (e, t) {
                  if ((C.debug('Changing setting', e, t), j.isPlainObject(e)))
                    j.extend(!0, l, e);
                  else {
                    if (t === M) return l[e];
            ...
            var i = y.isPlainObject(d)
              ...
              u =
                  ...
                  x.msRequestAnimationFrame,
                {
                  ...
                  onHide: function () {
                    u.debug('Removing nag', i.animation.hide),
                      a.remove(),
                      i.onHide && i.onHide();
                  },
                  dismiss: function (e) {
                  ...
                  storage: {
                    set: function (e, t) {
                      ...
                      if (
                        ...
                        if (y.cookie === C)
                          return void u.error(s.noCookieStorage);
                        y.cookie(e, t, n),
                          u.debug('Value stored using cookie', e, t, n);
                      }
                    },
                    get: function (e, t) {
                      var n;
                  ...
                  setting: function (e, t) {
                    if ((u.debug('Changing setting', e, t), y.isPlainObject(e)))
                      y.extend(!0, i, e);
                    else {
                      if (t === C) return i[e];
                      y.isPlainObject(i[e])
                      ...
                      'string' == typeof i &&
                        ...
                        y.each(i, function (e, t) {
                          ...
                          if (y.isPlainObject(r[n]) && e != o) r = r[n];
                            ...
                            if (!y.isPlainObject(r[t]) || e == o)
                              return (
                                r[t] !== C ? (a = r[t]) : u.error(s.method, i),
                                !1
                              );
                            r = r[t];
                          }
              ...
              S = {
                ...
                refresh: function () {
                  d.popup
                    ? (u = z(d.popup).eq(0))
                    : d.inline &&
                      ((u = v.nextAll(o.popup).eq(0)), (d.popup = u)),
                    d.popup
                ...
                event: {
                  start: function (e) {
                    ...
                    clearTimeout(S.hideTimer),
                      x || (S.showTimer = setTimeout(S.show, t));
                  },
                  end: function () {
                    var e = z.isPlainObject(d.delay) ? d.delay.hide : d.delay;
                    clearTimeout(S.showTimer),
                      (S.hideTimer = setTimeout(S.hide, e));
                  },
                  ...
                  hideGracefully: function (e) {
                    ...
                    e && !i && n
                      ? (S.debug('Click occurred outside popup hiding popup'),
                        S.hide())
                  ...
                  e || n || t
                    ? (S.debug('Creating pop-up html'),
                      ...
                      (u = z('<div/>')
                        ...
                        .html(e)),
                      d.inline
                        ? (S.verbose('Inserting popup element inline', u),
                          u.insertAfter(p))
                        : (S.verbose('Appending popup element to body', u),
                          u.appendTo(s)),
                      S.refresh(),
                      S.set.variation(),
                ...
                toggle: function () {
                  S.debug('Toggling pop-up'),
                    S.is.hidden()
                      ? (S.debug('Popup is hidden, showing pop-up'),
                        S.unbind.close(),
                        S.show())
                ...
                get: {
                  ...
                  content: function () {
                    return (
                      p.removeData(g.content),
                      p.data(g.content) || d.content || p.attr('title')
                    );
                  },
                  variation: function () {
                    return (
                      p.removeData(g.variation),
                      p.data(g.variation) || d.variation
                    );
                  },
                  popup: function () {
                    return u;
                  ...
                  calculations: function () {
                    ...
                    return (
                      ...
                      (s.target.margin.top = d.inline
                        ? parseInt(
                            I.getComputedStyle(i).getPropertyValue(
                              'margin-top'
                            ),
                            10
                          )
                  ...
                  nextPosition: function (e) {
                    ...
                    return (
                      y ||
                        (S.verbose('All available positions available'),
                        (y = S.get.positions())),
                ...
                set: {
                  position: function (e, t) {
                    if (0 !== v.length && 0 !== u.length) {
                      ...
                      if (
                        ...
                        return (
                          S.debug('Popup target is hidden, no action taken'), !1
                        );
                      switch (
                        (d.inline &&
                      ...
                      if (
                        ...
                        if (
                          (S.debug('Position is outside viewport', e),
                          b < d.maxSearchDepth)
                        )
                          return (
                            b++,
                  ...
                  variation: function (e) {
                    (e = e || S.get.variation()) &&
                      S.has.popup() &&
                      (S.verbose('Adding variation to popup', e),
                      u.addClass(e));
                  },
                  visible: function () {
                ...
                remove: {
                  ...
                  attempts: function () {
                    S.verbose('Resetting all searched positions'),
                      (b = 0),
                      (y = !1);
                  },
                },
                bind: {
                  events: function () {
                    S.debug('Binding popup events to module'),
                      ...
                      'hover' == d.on &&
                        p.on('touchstart' + a, S.event.touchstart),
                      S.get.startEvent() &&
                        p
                  ...
                  popup: function () {
                    S.verbose(
                      ...
                      u &&
                        S.has.popup() &&
                        u
                          .on('mouseenter' + a, S.event.start)
                          .on('mouseleave' + a, S.event.end);
                  },
                  close: function () {
                    (!0 === d.hideOnScroll ||
                      ('auto' == d.hideOnScroll && 'click' != d.on)) &&
                  ...
                  touchClose: function () {
                    S.verbose('Binding popup touchclose event to document'),
                      A.on('touchstart' + t, function (e) {
                        S.verbose('Touched away from popup'),
                  ...
                  clickaway: function () {
                    S.verbose('Binding popup close event to document'),
                      A.on('click' + t, function (e) {
                        S.verbose('Clicked away from popup'),
                          S.event.hideGracefully.call(C, e);
                      });
                  },
                },
                ...
                should: {
                  centerArrow: function (e) {
                    return (
                      !S.is.basic() &&
                      e.target.width <= 2 * d.arrowPixelsFromEdge
                    );
                  },
                },
                is: {
                ...
                reset: function () {
                  S.remove.visible(),
                    d.preserve
                      ? z.fn.transition !== L &&
                        u.transition('remove transition')
                      : S.removePopup();
                },
                setting: function (e, t) {
          ...
          var i = k.isPlainObject(h)
            ...
            p = {
              ...
              read: {
                ...
                settings: function () {
                  !1 !== i.total &&
                    (p.debug('Current total set in settings', i.total),
                    p.set.total(i.total)),
                    !1 !== i.value &&
              ...
              increment: function (e) {
                ...
                p.has.total()
                  ...
                  : ((n =
                      (t = p.get.percent()) + (e = e || p.get.randomValue())),
              ...
              get: {
                ...
                normalizedValue: function (e) {
                  if (e < 0)
                    return p.debug('Value cannot decrement below 0'), 0;
                  if (p.has.total()) {
                    if (e > p.total)
                      return (
                    ...
                    return (
                      p.debug('Value cannot increment above 100 percent'), 100
                    );
                  return e;
                },
              ...
              remove: {
                progressPoll: function () {
                  p.verbose('Removing progress poll timer'),
                    p.progressPoll &&
                      (clearTimeout(p.progressPoll), delete p.progressPoll);
                },
                nextValue: function () {
              ...
              set: {
                barWidth: function (e) {
                  100 < e
                    ...
                    ? p.error(s.tooLow, e)
                    : (c.css('width', e + '%'),
                      l.attr('data-percent', parseInt(e, 10)));
                },
                duration: function (e) {
                  ...
                  (e = 'string' == typeof e ? +e.replace('%', '') : e),
                    ...
                    p.has.total() ||
                      ((p.value =
                        0 < i.precision
                          ? Math.round(
                              (e / 100) * p.total * (10 * i.precision)
                            ) /
                            (10 * i.precision)
                          : Math.round((e / 100) * p.total * 10) / 10),
                      i.limitValues &&
                        (p.value =
                          100 < p.value ? 100 : p.value < 0 ? 0 : p.value)),
                    p.set.barWidth(e),
                    p.set.labelInterval(),
                    p.set.labels(),
                ...
                labelInterval: function () {
                  clearInterval(p.interval),
                    ...
                    (p.interval = setInterval(function () {
                      k.contains(T.documentElement, f) ||
                        (clearInterval(p.interval), (g = !1)),
                        p.set.labels();
                    }, i.framerate));
                },
                labels: function () {
                ...
                state: function (e) {
                  100 === (e = e !== A ? e : p.percent)
                    ? i.autoSuccess &&
                      !(p.is.warning() || p.is.error() || p.is.success())
                      ? (p.set.success(),
                ...
                barLabel: function (e) {
                  e !== A
                    ...
                    ? (p.verbose('Adding ratio to bar label'),
                      u.text(p.get.text(i.text.ratio)))
                    : 'percent' == i.label &&
                ...
                active: function (e) {
                  (e = e || i.text.active),
                    ...
                    p.remove.error(),
                    p.remove.success(),
                    (e = i.onLabelUpdate('active', e, p.value, p.total)) &&
                      p.set.label(e),
                    p.bind.transitionEnd(function () {
                ...
                warning: function (e) {
                  (e = e || i.text.warning),
                    ...
                    p.remove.error(),
                    p.complete(),
                    (e = i.onLabelUpdate('warning', e, p.value, p.total)) &&
                      p.set.label(e),
                    p.bind.transitionEnd(function () {
                ...
                error: function (e) {
                  (e = e || i.text.error),
                    ...
                    p.remove.warning(),
                    p.complete(),
                    (e = i.onLabelUpdate('error', e, p.value, p.total)) &&
                      p.set.label(e),
                    p.bind.transitionEnd(function () {
              ...
              update: {
                ...
                progress: function (e) {
                  var t;
                  !1 === (e = p.get.numericValue(e)) &&
                    p.error(s.nonNumeric, e),
              ...
              setting: function (e, t) {
                if ((p.debug('Changing setting', e, t), k.isPlainObject(e)))
                  k.extend(!0, i, e);
                else {
                  if (t === A) return i[e];
                  k.isPlainObject(i[e]) ? k.extend(!0, i[e], t) : (i[e] = t);
                  ...
                  'string' == typeof i &&
                    ...
                    k.each(i, function (e, t) {
                      ...
                      if (k.isPlainObject(r[n]) && e != o) r = r[n];
                        ...
                        if (!k.isPlainObject(r[t]) || e == o)
                          return (
                            r[t] !== A ? (a = r[t]) : p.error(s.method, i), !1
                          );
                        r = r[t];
                      }
                    })),
          ...
          p.each(function () {
            var e,
              ...
              f = {
                ...
                event: {
                  ...
                  click: function () {
                    var e = w(this),
                      t = f.get.rating(),
                      n = d.index(e) + 1;
                    ('auto' == i.clearable ? 1 === d.length : i.clearable) &&
                    t == n
                      ? f.clearRating()
                      : f.set.rating(n);
                  },
                ...
                setting: function (e, t) {
                  if ((f.debug('Changing setting', e, t), w.isPlainObject(e)))
                    w.extend(!0, i, e);
                  else {
                    if (t === S) return i[e];
              ...
              x = {
                ...
                setup: {
                  api: function (t, n) {
                    ...
                    E.extend(!0, e, c.apiSettings),
                      x.verbose('Setting up API request', e),
                      p.api(e);
                  },
                },
                can: {
                ...
                get: {
                  settings: function () {
                    E.isPlainObject(l) &&
                      ...
                      x.error(c.error.oldSearchSyntax, v));
                  },
                  inputEvent: function () {
                    var e = h[0];
                      ...
                      'category' === c.type
                        ? (x.debug('Finding result that matches', n),
                          E.each(e, function (e, t) {
                            if (
                              E.isArray(t.results) &&
                              (o = x.search.object(n, t.results, i)[0])
                            )
                              return !1;
                          }))
                ...
                select: {
                  firstResult: function () {
                    x.verbose('Selecting first result'),
                      r.first().addClass(f.active);
                  },
                },
                set: {
                  focus: function () {
                  ...
                  type: function (e) {
                    (e = e || c.type),
                      'category' == c.type && p.addClass(c.type);
                  },
                ...
                search: {
                  local: function (e) {
                    ...
                    x.set.loading(),
                      ...
                      0 < c.maxResults &&
                        (x.debug('Using specified max results', n),
                  ...
                  cache: function (e) {
                    ...
                    e
                      ? e &&
                        t &&
                        t[e] &&
                        (x.debug('Removing value from cache', e),
                        delete t[e],
                        p.data(u.cache, t))
                ...
                create: {
                  ...
                  results: function () {
                    0 === o.length &&
                      (o = E('<div />').addClass(f.results).appendTo(p));
                  },
                },
                inject: {
                  result: function (e, t, n) {
                    ...
                    x.verbose('Injecting results metadata', i),
                      i.data(u.result, e);
                  },
                  id: function (i) {
                ...
                save: {
                  results: function (e) {
                    x.verbose('Saving current search results to metadata', e),
                      p.data(u.results, e);
                  },
                },
                write: {
                ...
                addResults: function (e) {
                  if (
                    ...
                    return (
                      x.debug('onResultsAdd callback cancelled default action'),
                      !1
                    );
                  e
                    ? (o.html(e),
                  ...
                  return (
                    n || i
                      ? (0 < c.maxResults &&
                        ...
                        E.isFunction(t)
                          ? (o = t(e, a))
                          : x.error(g.noTemplate, !1))
                      : c.showNoResults &&
                        (o = x.displayMessage(g.noResults, 'empty')),
        ...
        return (
          y.each(function () {
            var i,
              ...
              h = {
                initialize: function () {
                  h.verbose('Initializing module for', g),
                    h.set.defaultSide(),
                    h.instantiate();
                },
                instantiate: function () {
                ...
                destroy: function () {
                  h.verbose('Destroying previous module for', g),
                    u.removeData(c).off(l);
                },
                refresh: function () {
                ...
                set: {
                  ...
                  duration: function (e) {
                    (e =
                      'number' == typeof (e = e || a.duration) ? e + 'ms' : e),
                ...
                setting: function (e, t) {
                  if ((h.debug('Changing setting', e, t), A.isPlainObject(e)))
                    A.extend(!0, a, e);
                  else {
                    if (t === P) return a[e];
          ...
          e.each(function () {
            var r,
              ...
              y = {
                ...
                bind: {
                  clickaway: function () {
                    y.verbose('Adding clickaway events to context', g),
                      c.closable &&
                        g
                          .on('click' + s, y.event.clickaway)
                          .on('touchend' + s, y.event.clickaway);
                  },
                  scrollLock: function () {
                    c.scrollLock &&
                ...
                show: function (e) {
                  if (
                    ((e = q.isFunction(e) ? e : function () {}), y.is.hidden())
                  ) {
                    if (
                      (y.refreshSidebars(),
                      c.overlay &&
                      ...
                      if (
                        (y.debug('Other sidebars currently visible'),
                        c.exclusive)
                      ) {
                        if ('overlay' != c.transition)
                          return void y.hideOthers(y.show);
                        y.hideOthers();
                ...
                remove: {
                  inlineCSS: function () {
                    y.debug('Removing inline css styles', r),
                ...
                is: {
                  ...
                  rtl: function () {
                    return (
                      y.cache.rtl === I &&
                        (y.cache.rtl = 'rtl' == m.css('direction')),
                      y.cache.rtl
                    );
                  },
                },
                setting: function (e, t) {
                  if ((y.debug('Changing setting', e, t), q.isPlainObject(e)))
                    q.extend(!0, c, e);
                  else {
                    if (t === I) return c[e];
                      ...
                      q.each(i, function (e, t) {
                        ...
                        if (q.isPlainObject(r[n]) && e != o) r = r[n];
                          ...
                          if (!q.isPlainObject(r[t]) || e == o)
                            return (
                              r[t] !== I ? (a = r[t]) : y.error(u.method, i), !1
                            );
                          r = r[t];
                        }
                      })),
              ...
              h = {
                ...
                destroy: function () {
                  h.verbose('Destroying previous instance'),
                    ...
                    t && t.disconnect(),
                    u
                      .off('load' + s, h.event.load)
                      .off('resize' + s, h.event.resize),
                ...
                bind: {
                  events: function () {
                    u
                      .on('load' + s, h.event.load)
                      .on('resize' + s, h.event.resize),
                      f
                        .off('scroll' + s)
                ...
                set: {
                  offset: function () {
                    h.verbose('Setting offset on element', d.offset),
                      ...
                      : ((e = Math.max(
                        ...
                        d.jitter
                          ? (h.debug(
                            ...
                            i.css({ height: e }))
                          : i.css({ height: '' }),
                        Math.abs(i.outerHeight() - h.cache.context.height) >
                          d.jitter &&
                          (h.debug(
              ...
              T = {
                ...
                determineTabs: function () {
                  ...
                  'parent' === y.context
                    ...
                    y.childrenOnly
                      ...
                      : ((a = p.find(t.tabs)),
                        T.debug('Searching tab context for tabs', p, a));
                },
                fix: {
                  callbacks: function () {
                    E.isPlainObject(r) &&
                ...
                event: {
                  click: function (e) {
                    ...
                    t !== D
                      ? (y.history
                          ? (T.verbose('Updating page state', e),
                            E.address.value(t))
                ...
                cache: {
                  ...
                  add: function (e, t) {
                    (e = e || h),
                      T.debug('Adding cached content for', e),
                      (i[e] = t);
                  },
                  remove: function (e) {
                    (e = e || h),
                      T.debug('Removing cached content for', e),
                      delete i[e];
                  },
                },
                set: {
                ...
                changeTab: function (d) {
                  var f =
                    ...
                    g =
                      m && !f
                        ? T.utilities.pathToArray(d)
                        : T.get.defaultPathArray(d);
                        ...
                        if (
                          ...
                          c
                            ...
                            : ((i = g.slice(0, e + 2)),
                              ...
                              (a = !T.is.tab(o)) &&
                                T.verbose('Tab parameters found', i)),
                          a && m)
                        )
                          return (
                            f
                  ...
                  content: function (t, n) {
                          ...
                          'response' == y.cacheType && T.cache.add(n, e),
                            ...
                            y.loadOnce
                              ...
                              : 'string' == typeof y.cacheType &&
                                ...
                                0 < o.children().length
                              ? setTimeout(function () {
                                  var e = (e = o.children().clone(!0)).not(
                                    'script'
                                  );
                                  T.cache.add(n, e);
                                }, 0)
                    ...
                    (n = n || t),
                      ...
                      y.cache && i
                        ...
                        : s
                        ? (T.set.loading(t),
                          T.debug('Content is already loading', n))
                        : E.api !== D
                ...
                setting: function (e, t) {
                  if ((T.debug('Changing setting', e, t), E.isPlainObject(e)))
                    E.extend(!0, y, e);
                  else {
                    if (t === D) return y[e];
                    ...
                    'string' == typeof i &&
                      ...
                      E.each(i, function (e, t) {
                        ...
                        if (E.isPlainObject(r[n]) && e != o) r = r[n];
                          ...
                          if (!E.isPlainObject(r[t]) || e == o)
                            return (
                              r[t] !== D ? (a = r[t]) : T.error(w.method, i), !1
                            );
                          r = r[t];
                        }
                      })),
          ...
          r.each(function (i) {
            var u,
              ...
              m = {
                ...
                animate: function (e) {
                  if (((u = e || u), !m.is.supported()))
                    return m.error(t.support), !1;
                  if (
                    (m.debug('Preparing animation', u.animation),
                    m.is.animating())
                  ) {
                    if (u.queue)
                      return (
                ...
                get: {
                  ...
                  animationClass: function (e) {
                    var t = e || u.animation,
                      n =
                        m.can.transition() && !m.has.direction()
                          ? m.get.direction() + ' '
                          : '';
                  ...
                  direction: function () {
                    return m.is.hidden() || !m.is.visible()
                      ? d.inward
                      : d.outward;
                  },
                  ...
                  displayType: function (e) {
                    return (
                      ...
                      u.displayType
                        ? u.displayType
                        : (e &&
                            f.data(n.displayType) === S &&
                            m.can.transition(!0),
                          f.data(n.displayType))
                    );
                  },
                  userStyle: function (e) {
                    return (e = e || f.attr('style') || '').replace(
                      /display.*?;/,
                      ''
                    );
                  },
                  ...
                  transition: function (e) {
                    ...
                    if (l === S || e) {
                      if (
                        ...
                        if ('none' == o || !o)
                          return void m.debug('No animation defined in css', s);
                ...
                setting: function (e, t) {
                  if ((m.debug('Changing setting', e, t), C.isPlainObject(e)))
                    C.extend(!0, u, e);
                  else {
                    if (t === S) return u[e];
          ...
          e.each(function () {
            var a,
              ...
              y = {
                ...
                destroy: function () {
                  y.verbose('Destroying previous module for', h),
                ...
                bind: {
                  events: function () {
                    ...
                    e
                      ...
                      : 'now' == l.on &&
                        (y.debug('Querying API endpoint immediately'),
                        y.query());
                  },
                },
                decode: {
                ...
                query: function () {
                  if (y.is.disabled())
                    y.debug('Element is disabled API request aborted');
                  else {
                    if (y.is.loading()) {
                    ...
                    if (
                      (l.defaultData &&
                        P.extend(!0, l.urlData, y.get.defaultData()),
                    ...
                    if (
                      ((y.cancelled = !1),
                      (n = y.get.templatedURL()) || y.is.mocked())
                    ) {
                      ...
                      o &&
                        ...
                        e &&
                          ...
                          P.each(e, function (e, t) {
                            ...
                            if (i === F)
                              return (
                                y.error(c.requiredParameter, n, o), (o = !1)
                              );
                            y.verbose('Found required variable', n, i),
                              (i = l.encodeParameters
                                ? y.get.urlEncodedValue(i)
                                : i),
                              (o = o.replace(t, i));
                          })),
                        t &&
                          ...
                          P.each(t, function (e, t) {
                            ...
                            o =
                              i !== F
                                ? (y.verbose('Optional variable Found', n, i),
                                  o.replace(t, i))
                      ...
                      n
                        ? ((t = P.isFunction(n)
                            ? (y.debug(
                              ...
                              n.call(v, r))
                            : (y.debug('Using settings specified response', n),
                              n)),
                ...
                set: {
                  error: function () {
                    y.verbose('Adding error state to element', p),
                      p.addClass(u.error);
                  },
                  loading: function () {
                ...
                remove: {
                  error: function () {
                    y.verbose('Removing error state from element', p),
                      p.removeClass(u.error);
                  },
                  loading: function () {
                    y.verbose('Removing loading state from element', p),
                      p.removeClass(u.loading);
                  },
                },
                get: {
                ...
                setting: function (e, t) {
                  if ((y.debug('Changing setting', e, t), P.isPlainObject(e)))
                    P.extend(!0, l, e);
                  else {
                    if (t === F) return l[e];
                    ...
                    'string' == typeof i &&
                      ...
                      P.each(i, function (e, t) {
                        ...
                        if (P.isPlainObject(r[n]) && e != o) r = r[n];
                          ...
                          if (!P.isPlainObject(r[t]) || e == o)
                            return (
                              r[t] !== F ? (a = r[t]) : y.error(c.method, i), !1
                            );
                          r = r[t];
                        }
                      })),
              ...
              v = {
                ...
                destroy: function () {
                  v.verbose('Destroying previous module'),
                    ...
                    t && t.disconnect(),
                    u
                      .off('load' + l, v.event.load)
                      .off('resize' + l, v.event.resize),
                    f
                ...
                checkVisibility: function (e) {
                  v.verbose('Checking visibility of element', v.cache.element),
                    !h &&
                      ...
                      v.bottomPassed(),
                      o.onUpdate &&
                        o.onUpdate.call(p, v.get.elementCalculations()));
                },
                passed: function (e, t) {
                  ...
                  if (e && t) o.onPassed[e] = t;
                    ...
                    n.passing &&
                      P.each(o.onPassed, function (e, t) {
                        n.bottomVisible ||
                        n.pixelsPassed > v.get.pixelsPassed(e)
                          ? v.execute(t, e)
                  ...
                  (e = e || !1) &&
                    (o.continuous
                      ? (v.debug('Callback being called continuously', t, n),
                        e.call(p, n, i))
                      : v.get.occurred(t) ||
                        (v.debug('Conditions met', t, n), e.call(p, n, i))),
                    v.save.occurred(t);
                },
                remove: {
                  fixed: function () {
                ...
                save: {
                  ...
                  scroll: function (e) {
                    (e = e + o.offset || f.scrollTop() + o.offset),
                      (v.cache.scroll = e);
                  },
                  direction: function () {
                    var e = v.get.scroll(),
                  ...
                  screenSize: function () {
                    v.verbose('Saving window position'),
                      (v.cache.screen = { height: f.height() });
                  },
                  position: function () {
                ...
                get: {
                  ...
                  occurred: function (e) {
                    return (
                      (v.cache.occurred !== O && v.cache.occurred[e]) || !1
                    );
                  },
                  direction: function () {
                    return (
                      v.cache.direction === O && v.save.direction(),
                      v.cache.direction
                    );
                  },
                  elementPosition: function () {
                    return (
                      v.cache.element === O && v.save.elementPosition(),
                      v.cache.element
                    );
                  },
                  elementCalculations: function () {
                    return (
                      v.cache.element === O && v.save.elementCalculations(),
                      v.cache.element
                    );
                  },
                  screenCalculations: function () {
                    return (
                      v.cache.screen === O && v.save.screenCalculations(),
                      v.cache.screen
                    );
                  },
                  screenSize: function () {
                    return (
                      v.cache.screen === O && v.save.screenSize(),
                      v.cache.screen
                    );
                  },
                  scroll: function () {
                    return (
                      v.cache.scroll === O && v.save.scroll(), v.cache.scroll
                    );
                  },
                  lastScroll: function () {
                    ...
                    'string' == typeof i &&
                      ...
                      P.each(i, function (e, t) {
                        ...
                        if (P.isPlainObject(r[n]) && e != o) r = r[n];
                          ...
                          if (!P.isPlainObject(r[t]) || e == o)
                            return (
                              r[t] !== O ? (a = r[t]) : v.error(s.method, i), !1
                            );
                          r = r[t];
                        }
                      })),
