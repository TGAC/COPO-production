...
!(function (t, e, i, s) {
  ...
  var n = {
    ...
    a =
      '<div role="treeitem" class="list-group-item" data-bs-toggle="collapse"></div>',
  ...
  t.extend(l.prototype, {
    init: function () {
      (this.tree = []),
        (this.nodes = []),
        this.settings.data &&
          (this.settings.data.isPrototypeOf(String) &&
            (this.settings.data = t.parseJSON(this.settings.data)),
          (this.tree = t.extend(!0, [], this.settings.data)),
      ...
      this.build(t(this.element), this.tree, 0),
        t(this.element).on('click', '.list-group-item', function (s) {
          t('.state-icon', this)
            .toggleClass(i.settings.expandIcon)
            .toggleClass(i.settings.collapseIcon),
            s.target.hasAttribute('href') &&
              (i.settings.openNodeLinkOnNewTab
    ...
    initData: function (e) {
      if (e.nodes) {
        ...
        t.each(e.nodes, function (t, e) {
          (e.nodeId = s.nodes.length),
            (e.parentId = i.nodeId),
            s.nodes.push(e),
            e.nodes && s.initData(e);
        });
      }
    },
    build: function (e, i, s) {
      ...
      s > 0 &&
        ...
        t.each(i, function (i, g) {
          ...
          if (g.nodes) {
            var c = t(o).addClass(
              g.expanded ? n.settings.expandIcon : n.settings.collapseIcon
            );
            h.append(c);
          }
          if (g.icon) {
          ...
          if (
            (h.append(g.text),
            g.href && h.attr('href', g.href),
            g.class && h.addClass(g.class),
            g.id && h.attr('id', g.id),
            e.append(h),
            g.nodes)
          ) {
    ...
    (t.fn.bstreeview = function (e) {
      return this.each(function () {
        t.data(this, 'plugin_bstreeview') ||
          t.data(this, 'plugin_bstreeview', new l(this, e));
      });
    });
