(function (root, factory) {
  ...
  var BootstrapDialogModal = function (element, options) {
    if (
      bootstrap &&
      bootstrap.Modal &&
      /^5\.[^\D0]\./.test(bootstrap.Modal.VERSION)
    ) {
      return new Modal(element, options);
    } else if (
      bootstrap &&
      bootstrap.Modal &&
      /^5\.0\.2/.test(bootstrap.Modal.VERSION)
    ) {
      return new Modal(element, options);
  ...
  BootstrapDialogModal.getModalVersion = function () {
    ...
    if (
      ...
      bootstrap &&
      bootstrap.Modal &&
      /^5\.0\.[23456789]/.test(bootstrap.Modal.VERSION)
    ) {
      version = 'v5.1';
  ...
  BootstrapDialogModal.METHODS_TO_OVERRIDE['v4.1'] = $.extend(
    {},
    BootstrapDialogModal.METHODS_TO_OVERRIDE['v3.3']
  );
  BootstrapDialogModal.METHODS_TO_OVERRIDE['v5.1'] = $.extend(
    {},
    BootstrapDialogModal.METHODS_TO_OVERRIDE['v4.1']
  );
  ...
  BootstrapDialog.SIZE_EXTRAWIDE = 'size-extrawide';
  ...
  BootstrapDialog.METHODS_TO_OVERRIDE['v5.1'] = $.extend(
    {},
    BootstrapDialog.METHODS_TO_OVERRIDE['v4.1'],
    {
  ...
  BootstrapDialog.prototype = {
    ...
    createFooterButtons: function () {
      var that = this;
      var $container = that.$modalFooter;
      this.indexedButtons = {};
      $.each(this.options.buttons, function (index, button) {
        if (!button.id) {
    ...
    createButton: function (button) {
      ...
      if (
        typeof button.data === 'object' &&
        button.data.constructor === {}.constructor
      ) {
    ...
    makeModalDraggable: function () {
      if (this.options.draggable) {
        ...
        $('body')
          .on('mousemove', { dialog: this }, function (event) {
            var dialog = event.data.dialog;
    ...
    realize: function () {
      ...
      this.getModal().data(
        'bs.modal',
        new BootstrapDialogModal(this.getModalForBootstrapDialogModal(), {
          backdrop:
            this.isClosable() && this.canCloseByBackdrop() ? true : 'static',
          keyboard: false,
          show: false,
        })
      );
    ...
    if (typeof dialog.options.onhide === 'function') {
      dialog.onHide(
        function (dialog) {
          ...
          return hideIt;
        }.bind({ onhide: dialog.options.onhide })
      );
    } else {
  ...
  BootstrapDialog.confirm = function () {
    ...
    if (confirmOptions.btnOKClass === null) {
      confirmOptions.btnOKClass = [
        'btn',
        confirmOptions.type.split('-')[1],
      ].join('-');
    }
